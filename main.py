...
def show_go_screen():
    ...
    draw_text(win, 'Press any key to continue', 15, winwidth/2, winheight * 3/4)
    pygame.display.flip()
    waiting = True
    while waiting == True and running == True:
        clock.tick(27)
...
while running==True:
    #print('outer:',running, game_over)
    # count+=1
    if game_over == True:
        #print('game over 1:',running, game_over)
        show_go_screen()
        #print('Game over 2:', running, game_over)
        if running == True:
            ...
            healthpacks=[]
        game_over = False
        #print('game over 3:',running, game_over)
    
    draw_text(win, f'Score: {man.score}', 18, winwidth/2, 7)
    pygame.display.flip()
    #print(man.score)
    
    # print(running, game_over, count)
